 ...
 */
public class TaxAllIndexsAnalysisGraphicAction extends ActionSupport implements Preparable {
    ...
    public void prepare() throws Exception {
        ...
        if (method.equals("detail")) {
            ...
            TaxCollectionAllIndexTableParameter taxCollectionAllIndexTableParameter = (TaxCollectionAllIndexTableParameter) session.getAttribute(SessionAttributeKey.SSLSYZB);
