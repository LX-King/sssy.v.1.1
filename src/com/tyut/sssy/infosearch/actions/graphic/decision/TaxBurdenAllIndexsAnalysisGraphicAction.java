 ...
 */
public class TaxBurdenAllIndexsAnalysisGraphicAction extends ActionSupport implements Preparable {
    ...
    public void prepare() throws Exception {
        ...
        if (method.equals("detail")) {
            ...
            TaxBurdenAllIndexTableParameter taxCollectionAllIndexTableParameter = (TaxBurdenAllIndexTableParameter) session.getAttribute(SessionAttributeKey.SFLSYZB);
