...
public class MicroTaskTestService {
	...
	public List<User> getRwzxryListByRwfkRq(String sjQ, String sjZ) {
		...
		List<String> rwzxryDmList = microTaskTestDao.getRwzxryDmListByRwfkRq(sjQ, sjZ);
	...
	public void deleteByBkhryAndSjQAndSjZ(String bkhryDm, String sjQ, String sjZ) {
		MicroTaskTestDao microTaskTestDao = new MicroTaskTestDao();
		microTaskTestDao.deleteByBkhryAndSjQAndSjZ(bkhryDm, sjQ, sjZ);
	}
	...
	public List<TaskTest> getTaskTestListByKhRq(String sjQ, String sjZ, String khrwLx) {
		MicroTaskTestDao microTaskTestDao = new MicroTaskTestDao();
		List<TaskTest> taskTestList = microTaskTestDao.getTaskTestListByKhRq(sjQ, sjZ, khrwLx);
