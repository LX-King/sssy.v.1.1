 ...
 * 
 * 项目名称：sssy20120618
 * 类名称：AnalysisMacroIndex  
 * 类描述：对应表 fx_hgzb  
 * 创建人：梁斌  
 * 创建时间：2012-6-18 下午11:34:47  
 * 修改人：梁斌  
 * 修改时间：2012-6-18 下午11:34:47  
 * 修改备注：  
 * @version 
 *
 */
public class AnalysisMacroIndex {
	
	private String nsrsbh;
	
	private String nsrmc;
	
	private String hsSwjgDm;
	
	private String zgSwjgDm;
	
	private int zbqz;
	
	private String fxqNd;
	
	private String jqNd;
	
	private String fxqSjq;
	
	private String fxqSjz;
	
	private BigDecimal fxqsj;
	
	private BigDecimal jqsj;
	
	private String fxzbDm;
	
	private String fxq;
	
	private String fxzblx;
	
	private String fxzblxMx;
	
	private String fxzblxMxDm;
	
	private BigDecimal bdl;
	...
	public String getHsSwjgDm() {
		return hsSwjgDm;
	}

	public void setHsSwjgDm(String hsSwjgDm) {
		this.hsSwjgDm = hsSwjgDm;
	}
	...
	public String getJqNd() {
		return jqNd;
	}

	public void setJqNd(String jqNd) {
		this.jqNd = jqNd;
	}
	...
	public BigDecimal getFxqsj() {
		return fxqsj;
	}

	public void setFxqsj(BigDecimal fxqsj) {
		this.fxqsj = fxqsj;
	}

	public BigDecimal getJqsj() {
		return jqsj;
	}

	public void setJqsj(BigDecimal jqsj) {
		this.jqsj = jqsj;
	}
	...
	public String getFxzblx() {
		return fxzblx;
	}

	public void setFxzblx(String fxzblx) {
		this.fxzblx = fxzblx;
	}
