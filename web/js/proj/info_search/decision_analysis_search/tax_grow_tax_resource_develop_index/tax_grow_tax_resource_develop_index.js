...
function query() {
    ...
    /*这里需要改*/
        var url = 'graphic/taxGrowGraphic.action';
        url += "?method=line" ;
        var chartUtil = null;
        var bbar = new Ext.Toolbar({
            items:[
                "->", {
                    text:"折线图",
                    handler:function () {
                        url = "graphic/taxGrowGraphic.action?method=line";
                ...
                }, "-",
                {
                    text:"柱状图",
                    handler:function () {
                        url = "graphic/taxGrowGraphic.action?method=column";
