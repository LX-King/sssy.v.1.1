...
function query() {
    ...
    var url = 'graphic/taxResolveChange.action';
    url += "?method=pie";
    var chartUtil = null;
    var bbar = new Ext.Toolbar({
        items:[
            "->", {
                text:"折线图",
                handler:function () {
                    url = "graphic/taxResolveChange.action?method=line";
            ...
            }, "-",
            {
                text:"柱状图",
                handler:function () {
                    url = "graphic/taxResolveChange.action?method=column";
            ...
            }, "-",
            {
                text:"饼图",
                handler:function () {
                    url = "graphic/taxResolveChange.action?method=pie";
