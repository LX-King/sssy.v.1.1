...
$(document).ready(function() {
    ...
    var columns = [[
        ...
        {field:'indexWeight',title:'指标权重',width:100,align:'center' /*,formatter:function(val, rec) {
         return '<a href="javascript:void(0)" onclick="showMenuDetail(' + rec.companyscaleCode + ') " style="border-bottom:1px solid blue;color:blue;">查看详情</a>';
         else
         return '无';
         }*/}
    ]];
