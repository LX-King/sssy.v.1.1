...
$(document).ready(function () {
    ...
    var url = 'sysmgr/registerTypeGraphic.action';

    var columns = [
        [
            {field:'id', title:'ID', width:50, sortable:true, align:'center'},
            {field:'qyzclxDm', title:'企业注册代码', width:100, sortable:true, align:'center'},
            {field:'mc', title:'企业注册名称', width:100, align:'center'}
        ]
    ];
    ...
    var toolbar = [
        {
            ...
            handler:function () {
                ...
                if (rows.length >= 5) {
                    Ext.Msg.alert("提示","<br>最多只能设置[5]种企业注册类型!<br>");
                } else {
