...
$(document).ready(function () {
    ...
    var url = 'sysmgr/taxCategoryGraphic.action';

    var columns = [
        [
            {field:'id', title:'ID', width:50, sortable:true, align:'center'},
            {field:'szDm', title:'税种代码', width:100, sortable:true, align:'center'},
            {field:'mc', title:'税种名称', width:100, align:'center'},
            {field:'yxbz', title:'有效标志', width:100, align:'center'}
        ]
    ];
    ...
    var toolbar = [
        {
            ...
            handler:function () {
                ...
                if (rows.length >= 5) {
                    Ext.Msg.alert("提示", "<br>最多只能设置[5]种税种!<br>");
                } else {
